...
public class GameState implements Comparable<GameState> {
	...
	/*
	 * the unit this state is working with
	 */
	public UnitView currentUnit;
    ...
    public GameState(State.StateView state, int playernum, int requiredGold, int requiredWood, boolean buildPeasants) {
        ...
        this.amountGold = 0;
        this.amountWood = 0;
        List<UnitView> unitIDs = state.getAllUnits();
        for(int i = 0; i < unitIDs.size(); i++)
        {
        	if(unitIDs.get(i).getTemplateView().getName().toLowerCase() == "peasant")
        	{
        		currentUnit = unitIDs.get(i);
        	}
        }
        m_state = state;
    }
    ...
    {    	
    	return this.currentUnit.getXPosition() * this.currentUnit.getYPosition() / 2.0;
    }
    ...
    @Override
    public int hashCode() {
        return (int) (this.getCost() * this.playerNum);
    }

	public void setParent(GameState _parent) {
		m_parent = _parent;
	}
